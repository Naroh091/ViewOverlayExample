...
public class SinOverlay extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sin_overlay, menu);
        return true;
    }
     ...
     */
    public static class SO extends Fragment {
